class Form {
  ...
  display(){
    ...
    this.button.mousePressed(()=>{
     ...
     this.aa3 = createElement("h3", "EACH QUESTION HAS 3 OPTIONS AND YOU CAN MOVE TO THE NEXT QUESTION ONLY AFTER YOU PRESS THE CORRECT OPTION.")
